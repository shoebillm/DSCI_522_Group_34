...
```{r median value of the 2 classes, echo=FALSE, fig.cap="Table 1. Results of computed median values of the 2 classes", out.width = '50%'}
...
```{r p-values, echo=FALSE, fig.cap="Table 2. The corresponding p-value of the null hypothesis", out.width = '50%'}
